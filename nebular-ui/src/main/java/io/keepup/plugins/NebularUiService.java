...
@Deploy
@Service
@ConditionalOnProperty(prefix = "keepup.plugins.nebularui", name = "enabled", havingValue = "true")
public class NebularUiService extends AbstractKeepupDeployBean {

    @Value("${keepup.plugins.nebularui.uri:/**}")
    private String dashboardUri;
    @Value("${keepup.plugins.nebularui.enabled:false}")
    ...
    public RouterFunction<ServerResponse> imgRouter() {
        logger.debug("Setting URI for Nebular UI dashboard with value = %s".formatted(dashboardUri));
